#!/usr/bin/env python3
"""Local Gradio UI for LookAlign V0.4.4 + V0.3.6 comparison."""
...
def build_app() -> gr.Blocks:
    with gr.Blocks(title="LookAlign V0.4.4") as demo:
        gr.Markdown("# LookAlign V0.4.4 — Bilateral Grid Affine Transfer")
        ...
        # ---- V0.4 tab ----
        with gr.Tab("V0.4.4 Bilateral Grid"):
        ...
        with gr.Tab("V0.3.6 (comparison)"):
            ...
            with gr.Row():
                ...
                xfeat_matches = gr.Image(label="XFeat* matches", type="filepath")
